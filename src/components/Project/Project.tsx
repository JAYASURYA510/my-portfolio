          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/JAYASURYA510/Deally_Dress_colur_suggestion_Frontend.git" target="\_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="https://dealy-dress-colur-suggestion.netlify.app/" target="\_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" /></a>
              </div>
            </header>
            <div className="body">
              <h3>Daily Dress colour suggestions for women</h3>
              <p>
                Developed a Daily Dress Color Suggestions' web application with user and admin login functionality. Users receive personalized dress color recommendations, while admins can upload images and data to the database via the admin panel. Implemented user authentication and admin controls to manage content effectively.
              </p>
            </div>
            <footer>
    ...
    <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"> <title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/JAYASURYA510/ForgetPassword_Frontend.git" target="\_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                <a href="https://forgetpaswords-fashions.netlify.app/" target="\_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> </div>
            </header>
            <div className="body">
              <h3>User Authentication With Forgotten Password</h3>
              <p> Developed a MERN stack web application with comprehensive user authentication, including signup, login, and password reset functionalities. Implemented secure account recovery using Nodemailer to send reset emails, and designed a responsive interface with Bootstrap for an optimal user experience </p>
            </div>
            <footer> <ul className="tech-list"> <li>React.Js</li> <li>Node.js</li> <li>Mongo.DB</li> </ul> </footer>
          </div>
        </ScrollAnimation>
          ...
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
                <title>RoomsBooking API</title>
                <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path>
              </svg>
              <div className="project-links">
                <a href="https://github.com/JAYASURYA510/RoomBooking-Node.js.git" target="\_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href=" https://roomsbookingnode-js.onrender.com/api//hall/getBookedRooms" target="\_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>RoomsBooking</h3>
              <p>
                Developed a room booking API that efficiently manages room allocations for users. The system checks room availability in real-time and assigns a room to the user if it's available. If a room is already booked, the API automatically redirects the user to an alternative available room. Utilized MongoDB for data storage to handle room status and booking information, ensuring seamless and reliable room management.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3> Assignment Mentor API</h3>
              <p>Developed a RESTful API using Node.js, Express.js, and MongoDB to facilitate the assignment of mentors to students. The API provides endpoints to create, read, update, and delete mentor and student records, as well as to assign mentors to students efficiently. The system ensures smooth management of mentor-student relationships and supports seamless integration with frontend applications.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Node.js</li>
